...
const login = () => {
  return (
    <div className="min-h-screen flex-col flex justify-center items-center">
      ...
      ></Image>
      <div className="w-[70%] h-[700px] border border-white-600/50 bg-gray-400/20 backdrop-blur-lg grid grid-cols-[30rem_1fr] overflow-hidden rounded-3xl">
        <div>
        ...
        <div className="flex-col flex justify-center items-center font-centurygothic">
          <div className="flex flex-col gap-10">
            ...
            <div className="flex flex-row gap-5 items-center bg-[#D9D9D9] p-3 rounded-full w-[350px]">
              ...
              <input
                className="bg-transparent placeholder:text-black w-full"
                placeholder="USUÁRIO"
              ></input>
            </div>
            ...
            <div className="flex flex-row justify-between text-black items-center text-sm">
              ...
              <Link href="www.youtube.com">Esqueceu a senha?</Link>
            </div>
            <div>

      ...
      <main className="flex-1">
        <div className="">
          ...
          <div className="flex justify-center items-center ">
            <div className="flex items-center justify-center w-full max-w-screen-2xl h-full max-h-4xl  bg-opacity-30 p-50 shadow-md rounded-4xl">
              {/* Formulario */}
              <form className=" items-center justify-center ml-[-100px]  w-[86rem] h-[30rem] grid grid-cols-2 gap-4">
                {/* Nome do Aluno */}
                <div>

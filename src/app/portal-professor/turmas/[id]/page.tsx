...
import { getSingleTurma } from "../actions/turmas-professor";
...
const DetalhesTurma = async (props: { params: Params }) => {
  ...
  const data = await getSingleTurma(id);
      ...
      <Container>
        ...
        <div className="w-3/4 mx-auto mt-10 border border-[#1d3e62] rounded-md px-6 py-6 bg-[#d9d9d9] text-[#0f172a] flex flex-col sm:flex-row justify-between">
          <div className="space-y-2 sm:w-[48%]">
            ...
            <p>
              <strong>TURMA:</strong> <span className="text-gray-600">02</span>
            </p>
            <p>
              <strong>CURSO:</strong>{" "}
              <span className="text-gray-600">{data.curso.nome}</span>
            </p>
            <p>
          ...
          <div className="space-y-2 w-full sm:w-[48%]">
            ...
            <p>
              <strong>ANO:</strong> <span className="text-gray-600">2025</span>
            </p>
            <p>
        ...
        <div className="w-3/4 mx-auto mt-10 border border-[#1d3e62] rounded-md px-8 py-6  bg-[#d9d9d9] text-[#0f172a] flex flex-wrap justify-between gap-y-4">
          ...
          <div className="w-full sm:w-[50%]">
            ...
            <textarea className="w-full h-28 mt-2 p-3 border rounded-md resize-none bg-[#d9d9d9] border-[#ABABAB] focus:outline-none focus:ring-2 focus:ring-[#a3a3a3]" />
          </div>
        </div>
